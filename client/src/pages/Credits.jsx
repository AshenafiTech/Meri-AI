    ...
    lg:px-8 py-12'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan) => (
          ...
          dark:border-cyan-700 rounded-lg shadow hover:shadow-lg
          transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id=== 'pro' ?
            ...
            <div className='flex-1'>
              ...
              <p className='text-2xl font-bold text-cyan-600 dark:text-cyan-300 mb-4'>${plan.price} 
                <span className='text-base font-normal text-gray-600
                dark:text-cyan-200'>{' '}/ {plan.credits} credits</span>
              </p>
              <ul className='list-disc list-inside text-sm text-gray-700 dark:text-cyan-200 space-y-1'>
            ...
            active:bg-cyan-800 text-white font-medium py-2 rounded 
